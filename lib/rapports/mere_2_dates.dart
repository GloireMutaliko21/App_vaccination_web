...
class RapportMeres2Dates extends StatefulWidget {
  const RapportMeres2Dates({Key? key}) : super(key: key);

  @override
  _RapportMeres2DatesState createState() => _RapportMeres2DatesState();
}

class _RapportMeres2DatesState extends State<RapportMeres2Dates> {
  List list = <dynamic>[];
    ...
    pdf.addPage(pw.Page(
        ...
        build: (pw.Context context) {
          return pw.Center(
            ...
            pw.Text(
                "MERES VACCINES ENTRE ${ControllersDates.date1.text} ET ${ControllersDates.date2.text}",
