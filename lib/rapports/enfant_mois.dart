...
class RapportEnfantMois extends StatefulWidget {
  @override
  _RapportEnfantMoisState createState() => _RapportEnfantMoisState();
}

class _RapportEnfantMoisState extends State<RapportEnfantMois> {
  List list = <dynamic>[];
    ...
    pdf.addPage(pw.Page(
        ...
        build: (pw.Context context) {
          return pw.Center(
            ...
            pw.Text("ENFANTS VACCINES CE MOIS",
